...
# Set the SECRET_KEY
SECRET_KEY = 'SWc4rqOKjQaYlqQfZc0rXuPMJ06bBUB5nrKWXcuTMQK5Bik9GAsHaKKFIjxozuKmhQUU'  # Set this to your unique secret key
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR,  # Add the base directory so Django can find templates in the root
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
